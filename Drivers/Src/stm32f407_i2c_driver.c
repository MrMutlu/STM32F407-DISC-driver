...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
	...
	tempreg = 0;
	tempreg |= (pI2CHandle->I2C_Config.I2C_DeviceAddress) << 1;	// shifted by 1 because 0th bit(ADD0) of I2C_OAR1 is not generally used (means 7 bit address of slave)
	...
	tempreg = 0;
	if(pI2CHandle->I2C_Config.I2C_SCLSpeed <= I2C_SCL_SM)
	{
	...
	}else
	{
		...
		}else if((pI2CHandle->I2C_Config.I2C_FMDutyCycle == I2C_FM_DUTY_CYCLE_16_9))
		{
